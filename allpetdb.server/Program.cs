...
namespace AllpetDB.Server
{
    class Program
    {
        ...
        public static allpetchain.httpserver.httpserver httpserver
        {
            get;
            private set;
        }
        ...
        static void Main(string[] args)
        {
            ...
            httpserver = new allpetchain.httpserver.httpserver();
        ...
        static void ShowDBBlock(string[] words)
        {
            ...
            using (var snap = storage.maindb.UseSnapShot())
            {
                ...
                var value = snap.GetValue(AllpetDB.systemtable_block, blockiddata);
